...
public class RoundRobinSchedulerTests {
    ...
    public static void main(String[] args) {
        System.out.println("========================================");
        System.out.println("   Round Robin Scheduler Unit Tests");
        System.out.println("========================================\n");
    ...
    private static void runTest(File file) throws IOException {
        ...
        // Get RR expected output from nested structure
        JsonObject expectedOutput = testCase.getAsJsonObject("expectedOutput");
        JsonObject rrExpected = expectedOutput.getAsJsonObject("RR");

        // Run Round Robin Scheduler
        RoundRobinScheduler scheduler = new RoundRobinScheduler(rrQuantum);
        SchedulerResult result = scheduler.schedule(processes, contextSwitch);

        // Check results
        boolean passed = checkResult(testName, result, rrExpected);
